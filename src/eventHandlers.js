...
const copyCatBlue = document.getElementById("mimic1")
const copyCatSalmon = document.getElementById("mimic2")

const mimicMaker = () => {
    const enteredRandomInfo  = document.getElementById("mimicField")

    copyCatBlue.textContent = `${enteredRandomInfo.value}`
    
    copyCatSalmon.textContent = `${enteredRandomInfo.value}`
}


document.getElementById("mimicField").addEventListener("keyup", mimicMaker)